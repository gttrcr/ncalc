...
*/
        ...
        */
        ...
        public static object Add(object a, object b)
        {
            ...
            Type typeCodeA = a.GetType();
            Type typeCodeB = b.GetType();

            if (typeCodeA == typeof(Complex))
            {
                if (typeCodeB == typeof(Complex))
                    return (Complex)a + (Complex)b;
                else
                    return (Complex)a + new Complex(Convert.ToDouble(b), 0);
            }
            else if (typeCodeB == typeof(Complex))
                return new Complex(Convert.ToDouble(a), 0) + (Complex)b;
            else
                return new Complex(Convert.ToDouble(a), 0) + new Complex(Convert.ToDouble(b), 0);
        }

        public static object Soubtract(object a, object b)
        {
            a = ConvertIfString(a);
            b = ConvertIfString(b);
